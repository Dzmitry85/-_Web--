...
})({"lHo9h":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "4a236f9275d0a351";
module.bundle.HMR_BUNDLE_ID = "1060b6948d59a337";
"use strict";
...
},{}],"9cKSv":[function(require,module,exports) {
...
function getDateDiff(dateFrom, dateTo) {
    ...
    const dateFromObj = _luxon.DateTime.fromISO(dateFrom);
    const dateToObj = _luxon.DateTime.fromISO(dateTo);
...
form.onsubmit = (event)=>{
    ...
    if (!firstDate || !secondDate) _printResultJs.printError('Oooopps! Введите дату');
    else {
        const dateREsult = getDateDiff(firstDate, secondDate);
        _printResultJs.printResult(dateREsult);
    }
};

},{"./printResult.js":"a7BQR","luxon":"1XCJZ"}],"a7BQR":[function(require,module,exports) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"1XCJZ":[function(require,module,exports) {
'use strict';
...
/**
 * @private
 */ var LuxonError1 = /*#__PURE__*/ function(_Error) {
...
/**
 * @private
 */ var InvalidDateTimeError1 = /*#__PURE__*/ function(_LuxonError) {
...
/**
 * @private
 */ var InvalidIntervalError1 = /*#__PURE__*/ function(_LuxonError2) {
...
/**
 * @private
 */ var InvalidDurationError1 = /*#__PURE__*/ function(_LuxonError3) {
...
/**
 * @private
 */ var ConflictingSpecificationError1 = /*#__PURE__*/ function(_LuxonError4) {
...
/**
 * @private
 */ var InvalidUnitError1 = /*#__PURE__*/ function(_LuxonError5) {
...
/**
 * @private
 */ var InvalidArgumentError1 = /*#__PURE__*/ function(_LuxonError6) {
...
/**
 * @private
 */ var ZoneIsAbstractError1 = /*#__PURE__*/ function(_LuxonError7) {
...
/**
 * @private
 */ var n1 = "numeric", s1 = "short", l = "long";
var DATE_SHORT = {
    year: n1,
    month: n1,
    day: n1
...
function asNumber(value) {
    ...
    if (typeof value === "boolean" || value === "" || Number.isNaN(numericValue)) throw new InvalidArgumentError1("Invalid unit value " + value);
    return numericValue;
}
...
/**
 * @private
 */ var Formatter1 = /*#__PURE__*/ function() {
...
var Invalid1 = /*#__PURE__*/ function() {
 ...
 */ var Zone1 = /*#__PURE__*/ function() {
   ...
   */ _proto.offsetName = function offsetName(ts, opts) {
        throw new ZoneIsAbstractError1();
    };
 ...
 * @implements {Zone}
 */ var SystemZone1 = /*#__PURE__*/ function(_Zone) {
 ...
 * @implements {Zone}
 */ var IANAZone1 = /*#__PURE__*/ function(_Zone) {
 ...
 * @implements {Zone}
 */ var FixedOffsetZone1 = /*#__PURE__*/ function(_Zone) {
 ...
 * @implements {Zone}
 */ var InvalidZone1 = /*#__PURE__*/ function(_Zone) {
 ...
 */ function normalizeZone(input, defaultZone) {
    ...
    else if (input instanceof Zone1) return input;
    else if (isString(input)) {
        var lowered = input.toLowerCase();
        if (lowered === "local" || lowered === "system") return defaultZone;
        else if (lowered === "utc" || lowered === "gmt") return FixedOffsetZone1.utcInstance;
        else if (IANAZone1.isValidSpecifier(lowered)) return IANAZone1.create(input);
        else return FixedOffsetZone1.parseSpecifier(lowered) || new InvalidZone1(input);
    } else if (isNumber(input)) return FixedOffsetZone1.instance(input);
    ...
    return input;
    else return new InvalidZone1(input);
}
 ...
 */ var Settings1 = /*#__PURE__*/ function() {
    function Settings() {
    }
    /**
   ...
   */ Settings.resetCaches = function resetCaches() {
     ...
     * @type {Zone}
     */ function get() {
                return normalizeZone(defaultZone1, SystemZone1.instance);
            },
...
function mapWeekdays(f) {
    var ms = [];
    for(var i = 1; i <= 7; i++){
        var dt = DateTime1.utc(2016, 11, 13 + i);
        ms.push(f(dt));
    }
    return ms;
}
...
/**
 * @private
 */ var PolyNumberFormatter1 = /*#__PURE__*/ function() {
...
/**
 * @private
 */ var PolyDateFormatter1 = /*#__PURE__*/ function() {
    function PolyDateFormatter(dt, intl, opts) {
        ...
        if (dt.zone.isUniversal) {
            ...
            if (dt.offset !== 0 && IANAZone1.create(offsetZ).valid) {
                z = offsetZ;
                this.dt = dt;
            } else {
                ...
                else this.dt = dt.offset === 0 ? dt : DateTime1.fromMillis(dt.ts + dt.offset * 60000);
            }
...
/**
 * @private
 */ var PolyRelFormatter1 = /*#__PURE__*/ function() {
...
/**
 * @private
 */ var Locale1 = /*#__PURE__*/ function() {
    Locale.fromOpts = function fromOpts(opts) {
        return Locale.create(opts.locale, opts.numberingSystem, opts.outputCalendar, opts.defaultToEN);
    };
    Locale.create = function create(locale, numberingSystem, outputCalendar, defaultToEN) {
        if (defaultToEN === void 0) defaultToEN = false;
        var specifiedLocale = locale || Settings1.defaultLocale; // the system locale is useful for human readable strings but annoying for parsing/formatting known formats
        var localeR = specifiedLocale || (defaultToEN ? "en-US" : systemLocale());
        var numberingSystemR = numberingSystem || Settings1.defaultNumberingSystem;
        var outputCalendarR = outputCalendar || Settings1.defaultOutputCalendar;
        ...
        return listStuff(this, undefined, defaultOK, function() {
            ...
            if (!_this3.meridiemCache) {
                ...
                _this3.meridiemCache = [
                    DateTime1.utc(2016, 11, 13, 9),
                    DateTime1.utc(2016, 11, 13, 19)
                ].map(function(dt) {
    ...
    _proto4.eras = function eras$1(length, defaultOK) {
        ...
        return listStuff(this, length, defaultOK, eras, function() {
            ...
            if (!_this4.eraCache[length]) _this4.eraCache[length] = [
                DateTime1.utc(-40, 1, 1),
                DateTime1.utc(2017, 1, 1)
            ].map(function(dt) {
    ...
    _proto4.numberFormatter = function numberFormatter(opts) {
        ...
        return new PolyNumberFormatter1(this.intl, opts.forceSimple || this.fastNumbers, opts);
    };
    _proto4.dtFormatter = function dtFormatter(dt, intlOpts) {
        if (intlOpts === void 0) intlOpts = {
        };
        return new PolyDateFormatter1(dt, this.intl, intlOpts);
    };
    _proto4.relFormatter = function relFormatter(opts) {
        if (opts === void 0) opts = {
        };
        return new PolyRelFormatter1(this.intl, this.isEnglish(), opts);
    };
...
function extractISOOffset(match, cursor) {
    var local = !match[cursor] && !match[cursor + 1], fullOffset = signedOffset(match[cursor + 1], match[cursor + 2]), zone = local ? null : FixedOffsetZone1.instance(fullOffset);
    return [
        {
        },
        zone,
...
function extractIANAZone(match, cursor) {
    var zone = match[cursor] ? IANAZone1.create(match[cursor]) : null;
    return [
        {
        },
        zone,
 ...
 */ var Duration1 = /*#__PURE__*/ function() {
    /**
   * @private
   */ function Duration(config) {
     ...
     */ this.values = config.values;
        /**
     * @access private
     */ this.loc = config.loc || Locale1.create();
        /**
     * @access private
   ...
   */ Duration.fromMillis = function fromMillis(count, opts) {
    ...
    Duration.fromObject = function fromObject(obj, opts) {
        ...
        if (obj == null || typeof obj !== "object") throw new InvalidArgumentError1("Duration.fromObject: argument expected to be an object, got " + (obj === null ? "null" : typeof obj));
        return new Duration({
            values: normalizeObject(obj, Duration.normalizeUnit),
            loc: Locale1.fromObject(opts),
    ...
    Duration.fromDurationLike = function fromDurationLike(durationLike) {
        ...
        else throw new InvalidArgumentError1("Unknown duration argument " + durationLike + " of type " + typeof durationLike);
    };
    ...
    Duration.invalid = function invalid(reason, explanation) {
        ...
        if (!reason) throw new InvalidArgumentError1("need to specify a reason the Duration is invalid");
        var invalid = reason instanceof Invalid1 ? reason : new Invalid1(reason, explanation);
        if (Settings1.throwOnInvalid) throw new InvalidDurationError1(invalid);
    ...
    Duration.normalizeUnit = function normalizeUnit(unit) {
        ...
        if (!normalized) throw new InvalidUnitError1(unit);
        return normalized;
    };
   ...
   */ _proto.toFormat = function toFormat(fmt, opts) {
        ...
        return this.isValid ? Formatter1.create(this.loc, fmtOpts).formatDurationFromString(this, fmt) : INVALID$2;
    };
    ...
    _proto.set = function set(values) {
        if (!this.isValid) return this;
        var mixed = _extends({
        }, this.values, normalizeObject(values, Duration.normalizeUnit));
        return clone$1(this, {
            values: mixed
        });
    };
...
function validateStartEnd(start, end) {
    if (!start || !start.isValid) return Interval1.invalid("missing or invalid start");
    else if (!end || !end.isValid) return Interval1.invalid("missing or invalid end");
    else if (end < start) return Interval1.invalid("end before start", "The end of an interval must be after its start, but you had start=" + start.toISO() + " and end=" + end.toISO());
    else return null;
}
/**
 ...
 */ var Interval1 = /*#__PURE__*/ function() {
    /**
   * @private
   ...
   */ Interval.invalid = function invalid(reason, explanation) {
        if (explanation === void 0) explanation = null;
        if (!reason) throw new InvalidArgumentError1("need to specify a reason the Interval is invalid");
        var invalid = reason instanceof Invalid1 ? reason : new Invalid1(reason, explanation);
        if (Settings1.throwOnInvalid) throw new InvalidIntervalError1(invalid);
    ...
    Interval.after = function after(start, duration) {
        var dur = Duration1.fromDurationLike(duration), dt = friendlyDateTime(start);
        return Interval.fromDateTimes(dt, dt.plus(dur));
    };
    Interval.before = function before(end, duration) {
        var dur = Duration1.fromDurationLike(duration), dt = friendlyDateTime(end);
    ...
    Interval.fromISO = function fromISO(text, opts) {
        ...
        if (s && e) {
            ...
            try {
                start = DateTime1.fromISO(s, opts);
            ...
            if (startIsValid) {
                var dur = Duration1.fromISO(e, opts);
                if (dur.isValid) return Interval.after(start, dur);
            } else if (endIsValid) {
                var _dur = Duration1.fromISO(s, opts);
   ...
   */ _proto.length = function length(unit) {
    ...
    _proto.toDuration = function toDuration(unit, opts) {
        if (!this.isValid) return Duration1.invalid(this.invalidReason);
 ...
 */ var Info1 = /*#__PURE__*/ function() {
   ...
   */ Info.hasDST = function hasDST(zone) {
        if (zone === void 0) zone = Settings1.defaultZone;
        var proto = DateTime1.now().setZone(zone).set({
            month: 12
        });
    ...
    Info.isValidIANAZone = function isValidIANAZone(zone) {
        return IANAZone1.isValidSpecifier(zone) && IANAZone1.isValidZone(zone);
    };
    Info.normalizeZone = function normalizeZone$1(input) {
        return normalizeZone(input, Settings1.defaultZone);
    };
    Info.months = function months(length, _temp) {
        ...
        return (locObj || Locale1.create(locale, numberingSystem, outputCalendar)).months(length);
    };
    Info.monthsFormat = function monthsFormat(length, _temp2) {
        ...
        return (locObj || Locale1.create(locale, numberingSystem, outputCalendar)).months(length, true);
    };
    Info.weekdays = function weekdays(length, _temp3) {
        ...
        return (locObj || Locale1.create(locale, numberingSystem, null)).weekdays(length);
    };
    Info.weekdaysFormat = function weekdaysFormat(length, _temp4) {
        ...
        return (locObj || Locale1.create(locale, numberingSystem, null)).weekdays(length, true);
    };
    Info.meridiems = function meridiems(_temp5) {
        var _ref5 = _temp5 === void 0 ? {
        } : _temp5, _ref5$locale = _ref5.locale, locale = _ref5$locale === void 0 ? null : _ref5$locale;
        return Locale1.create(locale).meridiems();
    };
    Info.eras = function eras(length, _temp6) {
        ...
        return Locale1.create(locale, null, "gregory").eras(length);
    };
...
function _diff(earlier, later, units, opts) {
    ...
    var duration = Duration1.fromObject(results, opts);
    if (lowerOrderUnits.length > 0) {
        var _Duration$fromMillis;
        return (_Duration$fromMillis = Duration1.fromMillis(remainingMillis, opts)).shiftTo.apply(_Duration$fromMillis, lowerOrderUnits).plus(duration);
...
function dateTimeFromMatches(matches) {
    ...
    var zone = null;
    var specificOffset;
    if (!isUndefined(matches.z)) zone = IANAZone1.create(matches.z);
    if (!isUndefined(matches.Z)) {
        if (!zone) zone = new FixedOffsetZone1(matches.Z);
...
function getDummyDateTime() {
    if (!dummyDateTimeCache) dummyDateTimeCache = DateTime1.fromMillis(1555555555555);
    return dummyDateTimeCache;
}
function maybeExpandMacroToken(token, locale) {
    if (token.literal) return token;
    var formatOpts = Formatter1.macroTokenToFormatOpts(token.val);
    if (!formatOpts) return token;
    var formatter = Formatter1.create(locale, formatOpts);
 ...
 */ function explainFromTokens(locale, input, format) {
    var tokens = expandMacroTokens(Formatter1.parseFormat(format), locale), units = tokens.map(function(t) {
    ...
    if (disqualifyingUnit) return {
        ...
        var _buildRegex = buildRegex(units), regexString = _buildRegex[0], handlers = _buildRegex[1], regex = RegExp(regexString, "i"), _match = match1(input, regex, handlers), rawMatches = _match[0], matches = _match[1], _ref6 = matches ? dateTimeFromMatches(matches) : [
            null,
            null,
            undefined
        ], result = _ref6[0], zone = _ref6[1], specificOffset = _ref6[2];
        if (hasOwnProperty(matches, "a") && hasOwnProperty(matches, "H")) throw new ConflictingSpecificationError1("Can't include meridiem when specifying 24-hour format");
        return {
            input: input,
            tokens: tokens,
            regex: regex,
...
function unitOutOfRange(unit, value) {
    return new Invalid1("unit out of range", "you specified " + value + " (of type " + typeof value + ") as a " + unit + ", which is invalid");
}
...
function adjustTime(inst, dur) {
    ...
    }), millisToAdd = Duration1.fromObject({
...
function parseDataToDateTime(parsed, parsedZone, opts, format, text, specificOffset) {
    ...
    if (parsed && Object.keys(parsed).length !== 0) {
        var interpretationZone = parsedZone || zone, inst = DateTime1.fromObject(parsed, _extends({
        }, opts, {
            zone: interpretationZone,
            specificOffset: specificOffset
        }));
        return setZone ? inst : inst.setZone(zone);
    } else return DateTime1.invalid(new Invalid1("unparsable", "the input \"" + text + "\" can't be parsed as " + format));
} // if you want to output a technical format (e.g. RFC 2822), this helper
// helps handle the details
function toTechFormat(dt, format, allowZ) {
    if (allowZ === void 0) allowZ = true;
    return dt.isValid ? Formatter1.create(Locale1.create("en-US"), {
        allowZ: allowZ,
        forceSimple: true
...
function quickDT(obj, opts) {
    var zone = normalizeZone(opts.zone, Settings1.defaultZone), loc = Locale1.fromObject(opts), tsNow = Settings1.now();
 ...
 */ var DateTime1 = /*#__PURE__*/ function() {
    /**
   * @access private
   */ function DateTime(config) {
        var zone = config.zone || Settings1.defaultZone;
        var invalid = config.invalid || (Number.isNaN(config.ts) ? new Invalid1("invalid input") : null) || (!zone.isValid ? unsupportedZone(zone) : null);
        /**
     * @access private
     */ this.ts = isUndefined(config.ts) ? Settings1.now() : config.ts;
        var c = null, o = null;
        if (!invalid) {
   ...
   */ DateTime.now = function now() {
    ...
    DateTime.utc = function utc() {
        ...
        opts.zone = FixedOffsetZone1.utcInstance;
        return quickDT({
            year: year,
            month: month,
            day: day,
    ...
    DateTime.fromJSDate = function fromJSDate(date, options) {
        ...
        var zoneToUse = normalizeZone(options.zone, Settings1.defaultZone);
        if (!zoneToUse.isValid) return DateTime.invalid(unsupportedZone(zoneToUse));
        return new DateTime({
            ts: ts,
            zone: zoneToUse,
            loc: Locale1.fromObject(options)
        });
    };
    DateTime.fromMillis = function fromMillis(milliseconds, options) {
        if (options === void 0) options = {
        };
        if (!isNumber(milliseconds)) throw new InvalidArgumentError1("fromMillis requires a numerical input, but received a " + typeof milliseconds + " with value " + milliseconds);
        ...
        return DateTime.invalid("Timestamp out of range");
            ...
            ts: milliseconds,
            zone: normalizeZone(options.zone, Settings1.defaultZone),
            loc: Locale1.fromObject(options)
        });
    };
    DateTime.fromSeconds = function fromSeconds(seconds, options) {
        ...
        if (!isNumber(seconds)) throw new InvalidArgumentError1("fromSeconds requires a numerical input");
        else return new DateTime({
            ts: seconds * 1000,
            zone: normalizeZone(options.zone, Settings1.defaultZone),
            loc: Locale1.fromObject(options)
    ...
    DateTime.fromObject = function fromObject(obj, opts) {
        ...
        var zoneToUse = normalizeZone(opts.zone, Settings1.defaultZone);
        if (!zoneToUse.isValid) return DateTime.invalid(unsupportedZone(zoneToUse));
        var tsNow = Settings1.now(), offsetProvis = !isUndefined(opts.specificOffset) ? opts.specificOffset : zoneToUse.offset(tsNow), normalized = normalizeObject(obj, normalizeUnit), containsOrdinal = !isUndefined(normalized.ordinal), containsGregorYear = !isUndefined(normalized.year), containsGregorMD = !isUndefined(normalized.month) || !isUndefined(normalized.day), containsGregor = containsGregorYear || containsGregorMD, definiteWeekDef = normalized.weekYear || normalized.weekNumber, loc = Locale1.fromObject(opts); // cases:
        // just a weekday -> this week's instance of that weekday, no worries
        // (gregorian data or ordinal) + (weekYear or weekNumber) -> error
        // (gregorian month or day) + ordinal -> error
        // otherwise just use weeks or ordinals or gregorian, depending on what's specified
        if ((containsGregor || containsOrdinal) && definiteWeekDef) throw new ConflictingSpecificationError1("Can't mix weekYear/weekNumber units with year/month/day or ordinals");
        if (containsGregorMD && containsOrdinal) throw new ConflictingSpecificationError1("Can't mix ordinal dates with month/day");
    ...
    DateTime.fromFormat = function fromFormat(text, fmt, opts) {
        ...
        if (isUndefined(text) || isUndefined(fmt)) throw new InvalidArgumentError1("fromFormat requires an input string and a format");
        var _opts = opts, _opts$locale = _opts.locale, locale = _opts$locale === void 0 ? null : _opts$locale, _opts$numberingSystem = _opts.numberingSystem, numberingSystem = _opts$numberingSystem === void 0 ? null : _opts$numberingSystem, localeToUse = Locale1.fromOpts({
            locale: locale,
            numberingSystem: numberingSystem,
            defaultToEN: true
    ...
    DateTime.invalid = function invalid(reason, explanation) {
        if (explanation === void 0) explanation = null;
        if (!reason) throw new InvalidArgumentError1("need to specify a reason the DateTime is invalid");
        var invalid = reason instanceof Invalid1 ? reason : new Invalid1(reason, explanation);
        if (Settings1.throwOnInvalid) throw new InvalidDateTimeError1(invalid);
        else return new DateTime({
            invalid: invalid
        });
    };
   ...
   */ _proto.resolvedLocaleOptions = function resolvedLocaleOptions(opts) {
        ...
        var _Formatter$create$res = Formatter1.create(this.loc.clone(opts), opts).resolvedOptions(this), locale = _Formatter$create$res.locale, numberingSystem = _Formatter$create$res.numberingSystem, calendar = _Formatter$create$res.calendar;
        return {
            locale: locale,
            numberingSystem: numberingSystem,
    ...
    _proto.toUTC = function toUTC(offset, opts) {
        ...
        return this.setZone(FixedOffsetZone1.instance(offset), opts);
    };
    _proto.toLocal = function toLocal() {
        return this.setZone(Settings1.defaultZone);
    };
    _proto.setZone = function setZone(zone, _temp) {
        ...
        zone = normalizeZone(zone, Settings1.defaultZone);
    ...
    _proto.minus = function minus(duration) {
        if (!this.isValid) return this;
        var dur = Duration1.fromDurationLike(duration).negate();
        return clone(this, adjustTime(this, dur));
    };
    _proto.startOf = function startOf(unit) {
        if (!this.isValid) return this;
        var o = {
        }, normalizedUnit = Duration1.normalizeUnit(unit);
    ...
    _proto.toFormat = function toFormat(fmt, opts) {
        ...
        return this.isValid ? Formatter1.create(this.loc.redefaultToEN(opts)).formatDateTimeFromString(this, fmt) : INVALID;
    };
    _proto.toLocaleString = function toLocaleString(formatOpts, opts) {
        if (formatOpts === void 0) formatOpts = DATE_SHORT;
        if (opts === void 0) opts = {
        };
        return this.isValid ? Formatter1.create(this.loc.clone(opts), formatOpts).formatDateTime(this) : INVALID;
    };
    _proto.toLocaleParts = function toLocaleParts(opts) {
        if (opts === void 0) opts = {
        };
        return this.isValid ? Formatter1.create(this.loc.clone(opts), opts).formatDateTimeParts(this) : [];
    };
    _proto.toISO = function toISO(opts) {
        if (opts === void 0) opts = {
        };
    ...
    _proto.diff = function diff(otherDateTime, unit, opts) {
        ...
        if (!this.isValid || !otherDateTime.isValid) return Duration1.invalid("created by diffing an invalid DateTime");
        var durOpts = _extends({
            locale: this.locale,
            numberingSystem: this.numberingSystem
        }, opts);
        var units = maybeArray(unit).map(Duration1.normalizeUnit), otherIsLater = otherDateTime.valueOf() > this.valueOf(), earlier = otherIsLater ? this : otherDateTime, later = otherIsLater ? otherDateTime : this, diffed = _diff(earlier, later, units, durOpts);
    ...
    DateTime.min = function min() {
        for(var _len = arguments.length, dateTimes = new Array(_len), _key = 0; _key < _len; _key++)dateTimes[_key] = arguments[_key];
        if (!dateTimes.every(DateTime.isDateTime)) throw new InvalidArgumentError1("min requires all arguments be DateTimes");
    ...
    DateTime.max = function max() {
        ...
        if (!dateTimes.every(DateTime.isDateTime)) throw new InvalidArgumentError1("max requires all arguments be DateTimes");
        return bestBy(dateTimes, function(i) {
            return i.valueOf();
        }, Math.max);
    } // MISC
    ...
    DateTime.fromFormatExplain = function fromFormatExplain(text, fmt, options) {
        ...
        var _options = options, _options$locale = _options.locale, locale = _options$locale === void 0 ? null : _options$locale, _options$numberingSys = _options.numberingSystem, numberingSystem = _options$numberingSys === void 0 ? null : _options$numberingSys, localeToUse = Locale1.fromOpts({
            locale: locale,
            numberingSystem: numberingSystem,
            defaultToEN: true
        });
...
function friendlyDateTime(dateTimeish) {
    if (DateTime1.isDateTime(dateTimeish)) return dateTimeish;
    else if (dateTimeish && dateTimeish.valueOf && isNumber(dateTimeish.valueOf())) return DateTime1.fromJSDate(dateTimeish);
    else if (dateTimeish && typeof dateTimeish === "object") return DateTime1.fromObject(dateTimeish);
    else throw new InvalidArgumentError1("Unknown datetime argument: " + dateTimeish + ", of type " + typeof dateTimeish);
}
var VERSION = "2.2.0";
exports.DateTime = DateTime1;
exports.Duration = Duration1;
exports.FixedOffsetZone = FixedOffsetZone1;
exports.IANAZone = IANAZone1;
exports.Info = Info1;
exports.Interval = Interval1;
exports.InvalidZone = InvalidZone1;
exports.Settings = Settings1;
exports.SystemZone = SystemZone1;
exports.VERSION = VERSION;
exports.Zone = Zone1;

},{}]},["lHo9h"], null, "parcelRequire738e")

//# sourceMappingURL=getDateDiff.8d59a337.js.map
