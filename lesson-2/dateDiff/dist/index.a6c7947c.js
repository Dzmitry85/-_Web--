...
var _appSwitchJs = require("../js/appSwitch.js");
[
    ...document.getElementsByTagName("button")
].forEach((button)=>{
    button.addEventListener("click", (event)=>{
        _appSwitchJs.appSwitch[event.target.id]();
    });
});

},{"../js/appSwitch.js":"3R5aF"}],"3R5aF":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "appSwitch", ()=>appSwitch
);
...
var appSwitch = {
    calcapp: ()=>{
        ...
        require("3c817842a7a400b1").then((resolve)=>{
        });
    },
    timerapp: ()=>{
        ...
        require("c08c28876e38ecdb").then((resolve)=>{
        });
    }
};

},{"3c817842a7a400b1":"c6FJs","c08c28876e38ecdb":"i3U95","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"c6FJs":[function(require,module,exports) {
module.exports = require("./helpers/browser/js-loader")(require('./helpers/bundle-url').getBundleURL('3h1NR') + "getDateDiff.8d59a337.js" + "?" + Date.now()).catch((err)=>{
    delete module.bundle.cache[module.id];
    throw err;
}).then(()=>module.bundle.root('9cKSv')
);
...
},{}],"i3U95":[function(require,module,exports) {
module.exports = require("./helpers/browser/js-loader")(require('./helpers/bundle-url').getBundleURL('3h1NR') + "timer.4d47d813.js" + "?" + Date.now()).catch((err)=>{
    delete module.bundle.cache[module.id];
    throw err;
}).then(()=>module.bundle.root('fmLM2')
);

},{"./helpers/browser/js-loader":"285qT","./helpers/bundle-url":"chiK4"}],"ciiiV":[function(require,module,exports) {
...
},{}]},["8EXkr","l5eIm"], "l5eIm", "parcelRequire738e")
